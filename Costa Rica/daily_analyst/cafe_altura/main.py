...
def main():
    ...
    if folders:
        ...
        missing_files = check_expected_files(selected_path, expected_files,prefixes,start_date='20241222',end_date='20250102')
            
        # Get the name of the selected folder
        selected_folder_name = os.path.basename(selected_path)

        records_data = get_records_data(selected_path, prefixes, '241222')
        
        # Get files with column mismatches
        mismatch_files = get_mismatch_files(selected_path, expected_columns, prefixes,target_date='20241222')
        
        # Get valid files
        valid_files = get_valid_files(selected_path, prefixes,target_date='20241222')
